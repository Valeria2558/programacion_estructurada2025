...
def menu_administradores(nombre,id):
    while True:
        ...
        if opcion == "1":
            ...
            exito = admin.agregar_vuelo(id,numero, origen, destino, hora_salida, hora_llegada, fecha_salida)
            if exito:
         ...
         if exito:
            ...
            print("\n\t..:: Ver administradores::..")
            administradores = admin.mostrar_administradores()
            if administradores:
                print(f"\n\tAdministradores Actuales:")
                print(f"{'ID':<5}{'Nombre':<20}{'Usuario':<15}")
                for adn in administradores:
            ...
            if exito:
                ...
                print("\n❌ No se pudo eliminar el pasajero. Verifique los datos e intente nuevamente.")
